...
class all { // to info
    ...
    int press[]=new int[3]; // price
    int press1[]=new int[3];// we want to understand it;
...
public class Mahata{
    ...
    public static void main(String[] args) {
        ...
        long pass, pass1 = 0; //un understand

        short chois1; //chois1 ==> firstChois
        do {
            ...
            if (chois1 == 1) {//خاص بالموظف اللي فوق الماكينه
                short chois1_1; //chois1_1 ==> firstChois_1
                do {
                    output_pat(all_letr);
                    ...
                    do {
                        ...
                        switch (chois1_2) {
                            case 1:
                                ...
                                for (int i=0; i<3; i++){
                                     x[i] = all_letr.press[i] * all_letr.letrs[i];
                                    x1[i] = all_letr.press1[i] * all_letr.letrs[i];
    ...
    public static void input_leatr(all all) {
        ...
        switch (chois1_3) {
            case 1:
                all.letrs[0] = input_l();
                all.press1[0] = input_s();
                all.press[0] = input_p(all,chois1_3);
                break;
            case 2:
                all.letrs[1] = input_l();
                all.press1[1] = input_s();
                all.press[1] = input_p(all,chois1_3);
                break;
            case 3:
                all.letrs[2] = input_l();
                all.press1[2] = input_s();
                all.press[2] = input_p(all,chois1_3);
                break;
        }
    }
    ...
    public static int input_p(all all,short s) {
        ...
        if (c<=all.press1[s-1]){
            ...
            System.out.println("انت الان تبيع بخساره= "+(all.press1[s-1]-c)+"ريال لللتر الواحد وبدون ربح  ");
    ...
    public static void out_put(all all) {
        ...
        for (int i = 0; i < 3; i++)
            System.out.println(all.name[i] + "                               " + all.letrs[i] + "         " + "                    " + all.press[i] + "                         "+all.eranings[i]+"          ");
    }
    ...
    public static void out_put_leter(short m ,all all) {
        ...
        System.out.println("سعر اللتر الواحد =" +all.press[m-1]);
        ...
        else if (all.press[m-1]!=0&&all.letrs[m-1]!=0){
            do {
    ...
    public static int iiiii(int mony,short m,all all){
     ...
     public static void chang_press(all all_letr){
        System.out.println("للبترول ادخل الرقم [1]");
        System.out.println("للديزل ادخل الرقم [2]");
        System.out.println("للغاز ادخل الرقم [3]");
        ...
        int chose = in.nextInt();
            ...
            all_letr.press[chose-1] = in.nextInt();
